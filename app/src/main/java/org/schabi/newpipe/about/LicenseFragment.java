...
public class LicenseFragment extends Fragment {
    ...
    public static LicenseFragment newInstance(final SoftwareComponent[] softwareComponents) {
        ...
        bundle.putParcelableArrayList(
                ARG_COMPONENTS, new ArrayList<>(Arrays.asList(softwareComponents)));
     ...
     */
    private void showLicense(final License license) {
        LicenseDialog.newInstance(license).show(getParentFragmentManager(), license.getName());
    }

    @Override
    public void onCreate(@Nullable final Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        softwareComponents = getArguments().getParcelableArrayList(ARG_COMPONENTS);

        // Sort components by name
        Collections.sort(softwareComponents, (o1, o2) -> o1.getName().compareTo(o2.getName()));
    }
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable final ViewGroup container,
        ...
        licenseLink.setOnClickListener(v -> showLicense(StandardLicenses.GPL3));
        ...
        for (final SoftwareComponent component : softwareComponents) {
            ...
            componentView.setOnClickListener(v -> showLicense(component.getLicense()));
    ...
    public boolean onContextItemSelected(@NonNull final MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_show_license:
                showLicense(component.getLicense());
        }
        return false;
    }
}
